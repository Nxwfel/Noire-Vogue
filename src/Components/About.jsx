  ...
  return (
    <div className='h-screen w-screen bg-black flex-col'>
        ...
        <div className='flex h-1/3 w-screen justify-center'> 
            <div className='ml-10 max-md:ml-5 justify-self-start w-1/2 text-wrap flex-col max-sm:justify-center max-sm:items-center max-sm:ttext-center'> 
            ...
            <div className='justify-self-end w-1/2 text-wrap max-sm:hidden'>
