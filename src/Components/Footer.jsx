  ...
  return (
    <div className='border-t-1 border-neutral-500 h-96 w-screen bg-black flex'>
        ...
        <div className=' flex flex-col justify-center'>
          ...
          <div className='pl-20 flex flex-col justify-center items-center mr-150'>
          <ul class="wrapper">
            ...
            <div className=' flex flex-col justify-center items-center gap-4'>
                <ul>
                <li className='text-white text-2xl'> Site Infos</li>  
                <li className='text-white text-2xl'> More Details</li>
                <li className='text-white text-2xl'> Contact us</li>
                </ul>     
            </div>
            </div>
            </div>
