...
const ProductList = () => {
  return (
    ...
    >
        <h1 className='font-syne font-bold text-sm text-black pr-9 ml-auto mr-auto mt-4 uppercase'>noire-vauge</h1>
        <div className='flex ml-auto mr-auto mt-10 gap-10'>
          <div className='h-12 w-20 pb-2 bg-transparent hover:border-2 hover:border-transparent hover:border-b-white'>
            <button className='text-3xl font-syne font-bold text-white cursor-pointer'>
              Tops
            </button>
          </div>
          <div className='h-12 w-20 pb-2 bg-transparent hover:border-2 hover:border-transparent hover:border-b-white'>
          ...
          <div className='grid grid-cols-4 ml-auto mr-auto mt-10 gap-10 max-w-screen min-h-screen'>
